...
<body>
      ...
      <div class="flex items-center">
        <div class="relative">
          <button class="flex items-center focus:outline-none">
            ...
            <span><?php echo e(session('user')->full_name); ?></span>
  ...
  <div class="flex min-h-screen">
    ...
    <div class="flex-1 p-8 bg-gray-50">
      <div class="mb-8">
        <h1 class="font-title text-3xl text-gray-800">Good Morning, <?php echo e(session('user')->full_name); ?></h1>
...
</html><?php /**PATH C:\educonnect\loginEDC\resources\views/dashboard.blade.php ENDPATH**/ ?>