    ...
    <div class="page-wrapper" id="page-wrapper">
        ...
        <div class="right" id="right-panel">
            <div class="form-container" id="form-container">
                ...
                <form method="POST" action="<?php echo e(route('auth.forgot_password_process')); ?>">
                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\educonnect\loginEDC\resources\views/auth/forgot_password.blade.php ENDPATH**/ ?>