    ...
    <div class="page-wrapper" id="page-wrapper">
        ...
        <div class="right" id="right-panel">
            <div class="form-container" id="form-container">
                ...
                <form method="POST" action="<?php echo e(route('auth.security_question_process')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <?php endif; ?>
                    <input type="text" value="<?php echo e($security_question); ?>" class="security-question-box" readonly>
...
</html><?php /**PATH C:\educonnect\loginEDC\resources\views/auth/security_question.blade.php ENDPATH**/ ?>