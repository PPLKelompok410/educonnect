...
<body class="bg-white text-gray-800">
  ...
  <section class="flex flex-col md:flex-row items-center justify-between px-6 md:px-20 py-20 bg-white">
    ...
    <img src="<?php echo e(asset('assets/images/logolanding.png')); ?>" alt="EduConnect" class="w-full md:w-1/2 mt-10 md:mt-0">
  </section>
...
</html><?php /**PATH C:\educonnect\loginEDC\resources\views/welcome.blade.php ENDPATH**/ ?>