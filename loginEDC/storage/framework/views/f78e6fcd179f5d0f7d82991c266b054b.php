    ...
    <div class="page-wrapper" id="page-wrapper">
        ...
        <div class="right" id="right-panel">
            <div class="form-container" id="form-container">
                ...
                <form method="POST" action="<?php echo e(route('auth.reset_password_process')); ?>">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-links">
                        <a href="<?php echo e(route('auth.login')); ?>">Kembali ke halaman login</a>
                    </div>
...
</html><?php /**PATH C:\educonnect\loginEDC\resources\views/auth/reset_password.blade.php ENDPATH**/ ?>