        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center space-x-4">
                    <h1 class="text-2xl font-bold text-gray-900 font-opensans">EduConnect Admin</h1>
                    <span class="text-gray-400">|</span>
                    <h2 class="text-lg font-semibold text-primary font-opensans">Manage Upgrade Plan</h2>
                </div>
                <div class="flex items-center space-x-4">
                    <span class="text-sm text-gray-600 font-poppins">Admin Dashboard</span>
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
                    ...
                    <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
                        ...
                        <button onclick="window.location.href='{{ route('admin.dashboard') }}'" 
                                class="btn-back text-white px-6 py-2 rounded-lg font-semibold font-poppins btn-action flex items-center space-x-2">
