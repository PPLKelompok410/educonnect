<div x-data="{ open: true }" class="flex min-h-screen bg-gray-100">
  <div :class="open ? 'w-64' : 'w-16'" class="bg-white border-r border-gray-200 transition-all duration-300 ease-in-out flex flex-col">
    ...
    <div class="flex items-center justify-between p-4 border-b border-gray-200">
      ...
      <button @click="open = !open" class="text-gray-500 hover:text-gray-700 focus:outline-none transition-colors">
    ...
    <nav class="flex-1 px-4 py-4 space-y-2">
      ...
      <a href="{{ route('dashboard') }}" 
         class="sidebar-item flex items-center p-3 rounded-lg transition-all duration-300 hover:translate-x-1 {{ request()->routeIs('dashboard') ? 'bg-blue-100 text-blue-700 border-r-4 border-blue-600' : 'hover:bg-blue-50 text-gray-700 hover:text-blue-600' }}">
      ...
      <a href="{{ route('matkul.index') }}" 
         class="sidebar-item flex items-center p-3 rounded-lg transition-all duration-300 hover:translate-x-1 {{ request()->routeIs('matkul.*') ? 'bg-blue-100 text-blue-700 border-r-4 border-blue-600' : 'hover:bg-blue-50 text-gray-700 hover:text-blue-600' }}">
        <svg class="w-5 h-5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
      ...
      <a href="{{ route('events.index') }}" 
         class="sidebar-item flex items-center p-3 rounded-lg transition-all duration-300 hover:translate-x-1 {{ request()->routeIs('events.*') ? 'bg-blue-100 text-blue-700 border-r-4 border-blue-600' : 'hover:bg-blue-50 text-gray-700 hover:text-blue-600' }}">
        <svg class="w-5 h-5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
      ...
      <a href="{{ route('topcontributors.index') }}" 
         class="sidebar-item flex items-center p-3 rounded-lg transition-all duration-300 hover:translate-x-1 {{ request()->routeIs('topcontributors.*') ? 'bg-blue-100 text-blue-700 border-r-4 border-blue-600' : 'hover:bg-blue-50 text-gray-700 hover:text-blue-600' }}">
        <svg class="w-5 h-5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
      ...
      <a href="{{ route('upgrade.plans') }}" 
         class="sidebar-item flex items-center p-3 rounded-lg transition-all duration-300 hover:translate-x-1 {{ request()->routeIs('upgrade.*') ? 'bg-blue-100 text-blue-700 border-r-4 border-blue-600' : 'hover:bg-blue-50 text-gray-700 hover:text-blue-600' }}">
        <svg class="w-5 h-5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
